...
PROJECT_NAME ?= provider-volcengine-terraform
PROJECT_REPO ?= github.com/warjiang/$(PROJECT_NAME)
...
REGISTRY_ORGS ?= xpkg.upbound.io/warjiang
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/warjiang
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/warjiang
XPKGS = $(PROJECT_NAME)
...
xpkg.build.provider-volcengine-terraform: do.build.images
